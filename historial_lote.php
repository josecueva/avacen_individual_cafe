...
if($cuenta_c==0){$estados["cata"]="<h6><font color=red>PENDIENTE DE CATA</font></h6>";$movimientos[]="PENDIENTE DE CATA";}else{
...
/*		echo "
		...
		<td><h4>Estimacion ".$estimado[$estimado_actual]["year"]."</td><td><h4>".$estimado[$estimado_actual]["estimados"]."qq</td></tr>
...
echo "<tr><th align=right><h4>Exportable</th><td align=right><h4>".$lote["rto_exportable"]."<font size=1>gr/250</td><td align=right><h4>".round($exportable_prc,1)."%</td><td align=right><h4>".round($exportable_qq,2)." qq</td></tr>";
echo "<tr><th align=right><h4>Descarte</th><td align=right><h4>".$lote["rto_descarte"]."<font size=1>gr/250</td><td align=right><h4>".round($descarte_prc,1)."%</td><td align=right><h4>".round($descarte_qq,2)." qq</td></tr>";
echo "<tr><th align=right><h4>Trillado</th><td align=right><h4>".$trillado_gr."<font size=1>gr/250</td><td align=right><h4>".round($trillado,1)." %</td><td align=right><h4>".round($trillado_qq,2)." qq</td></tr>";
