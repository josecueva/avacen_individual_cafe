...
$SQL_edit="DELETE FROM certificacion WHERE id='".$_GET["borra"]."'";
...
echo "<div align=center><h1>Borrar la certificación del usuario</h1><br><h2>".$socio["nombres"]." ".$socio["apellidos"]."</h2><br><br>";

echo "<notif>¿ESTA SEGURO?</notif><br><br>";

echo "<table class=tablas><tr>";
echo "<td width=50%><a href=historial_certificacion_borrar.php?borra=".$_GET["id"]."&socio=".$_GET["socio"]."><notifsi>SI</notifsi></a></td>";
